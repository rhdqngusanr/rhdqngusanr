...
- **비전검사기 프로그램 제작 (2022.11)**
  - OpenCV와 C# , Microsoft Machine Learning 을 사용하여 장비의 흑점과 오염도를 측정하는 비전검사 전이학습 프로그램을 만들었습니다.

- **2022.11~**
  - OpenCV, ROS 기반으로 회사프로젝트중이며 퇴근후에는 구글 스토어 배포목적 서비스 app 서브프로젝트를 팀과 하고있습니다.

- **else**
  - 제가 처음부터 만들진 않았지만 회사가 운영하는 앱 FRD500 , RadonEye 등을 구글 정책 변경으로 인한 업데이트와 유지보수를 하고있습니다.
